...
public class MainFernanShop {
    public static void main(String[] args) {
        ...
        //TODO me estaba dando fallo, comentado para seguir ensamblando
        ...
        while (true) {
            ...
            switch (op) {
                ...
                case "2":
                    ...
                    if (tienda.registraCliente(nombre, apellido, direccion, localidad, provincia, email, telefono, clave)) {
                        System.out.println("Usuario registrado con éxito.");
                    } else System.out.println("Error. Algunos de los datos son incorrectos o no permitido");
                    Utils.pulseParaContinuar();
                    Utils.limpiaPantalla();
